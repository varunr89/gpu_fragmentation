...
We bridge these approaches through four contributions:
\begin{enumerate}
...
\item An open-source interactive visualization tool\footnote{\url{https://github.com/varunr89/gpu-scheduling-viz}} for exploring GPU allocation, fragmentation, and scheduling dynamics across experiments. The tool uses a plugin-based architecture, allowing users to mix and match allocation policies, placement strategies, and scheduling algorithms.
\end{enumerate}
All code, including our extended Gavel+FGD simulator, is available at \url{https://github.com/varunr89/gavel}.
